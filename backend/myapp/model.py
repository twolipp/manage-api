...
#   timestamp: 2024-07-19T19:42:21+00:00
...
class UnsubscribeFromNotificationsPayload(BaseModel):
    ...
    clientMutationId: Optional[String] = None
    success: Optional[Boolean] = None
    typename__: Optional[Literal['UnsubscribeFromNotificationsPayload']] = Field(
        'UnsubscribeFromNotificationsPayload', alias='__typename'
    )
...
class UserListItemsConnection(BaseModel):
    ...
    edges: Optional[List[Optional[UserListItemsEdge]]] = Field(default_factory=list)
    nodes: Optional[List[Optional[UserListItems]]] = Field(default_factory=list)
    pageInfo: PageInfo
    totalCount: Int
